#line 1 "E:/Arduino Works 02.02.2017/Home_Auto_All/16F72 softUART and Control Sys/Full System shorter version/New_16F628/MikroC/New Test/MyProject.c"
char uart_rd;
char uart_string[] = "";
...
while(1) {
 ...
 uart_string[k] = UART1_Read();
 UART1_Write(uart_string[k]);
 if(uart_string[k]=='K'){
